...
public class AverageLessSpecification implements ArraySpecification {
    private static final Logger logger = LogManager.getLogger(AverageLessSpecification.class);
    private final double threshold;

    public AverageLessSpecification(double threshold) {
        this.threshold = threshold;
        logger.info("Created AverageLessSpecification with threshold: {}", threshold);
    }
