...
public class MaxLessSpecification implements ArraySpecification {
    private static final Logger logger = LogManager.getLogger(MaxLessSpecification.class);
    private final int threshold;

    public MaxLessSpecification(int threshold) {
        this.threshold = threshold;
        logger.info("Created MaxLessSpecification with threshold: {}", threshold);
    }
