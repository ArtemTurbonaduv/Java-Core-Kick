...
public class SumGreaterSpecification implements ArraySpecification {
    private static final Logger logger = LogManager.getLogger(SumGreaterSpecification.class);
    private final int threshold;

    public SumGreaterSpecification(int threshold) {
        this.threshold = threshold;
        logger.info("Created SumGreaterSpecification with threshold: {}", threshold);
    }
